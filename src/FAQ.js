    ...
    return (
      <div className="white about-section">
        <div className="container faq">
          ...
          <p>Graphite is also <a href="https://github.com/Graphite-Docs/graphite" rel="noopener noreferrer" target="_blank">open source</a> and in the unlikely event that Graphite shuts its doors, the software can be run locally from the source code. This means you do not need a web server to access, create, share, and connect.</p>
